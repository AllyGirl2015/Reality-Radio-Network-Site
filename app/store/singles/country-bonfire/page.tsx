...
export const metadata: Metadata = {
  title: 'Country Bonfire | Johnathan Gold & Guilded Hearts',
  description: 'Buy Country Bonfire by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function CountryBonfirePage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-JG-HR02',
    buyLink: 'https://square.link/u/wqT7BO6v',
    description: 'Sparks fly around the flames of country rebellion.',
  };
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr] gap-6 md:gap-8 lg:gap-12 items-start">
            ...
            <div>
              ...
              <Link href="/store/albums/heartfelt-rebellion" className="inline-flex items-center gap-2 text-sm text-cyan-400 hover:text-cyan-300 transition-colors mb-6">
