...
export const metadata: Metadata = {
  title: 'Gas Station Prayers | Johnathan Gold & Guilded Hearts',
  description: 'Buy Gas Station Prayers by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function GasStationPrayersPage() {
  const single = {
    title: 'Gas Station Prayers',
    ...
    price: 0.99,
    catalog: 'RRN-JG-AC05',
    buyLink: 'https://square.link/u/mO1DOqHN',
    description: 'Finding faith in unexpected places along the highway.',
  };
