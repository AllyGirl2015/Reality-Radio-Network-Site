...
export const metadata: Metadata = {
  title: 'The Line Was Crossed | Mathew Cage',
  description: 'Buy The Line Was Crossed by Mathew Cage. Digital download $0.99',
};

export default function TheLineWasCrossedPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-MC-SP03',
    buyLink: 'https://square.link/u/VOSlMOow',
    description: 'There\'s no going back after some boundaries are broken.',
  };
