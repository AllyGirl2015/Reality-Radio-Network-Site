...
export const metadata: Metadata = {
  title: 'Fallen Dust | Mathew Cage',
  description: 'Buy Fallen Dust by Mathew Cage. Digital download $0.99',
};

export default function FallenDustPage() {
  const single = {
    title: 'Fallen Dust',
    artist: 'Mathew Cage',
    album: 'High Hit',
    ...
    price: 0.99,
    catalog: 'RRN-MC-HH03',
    buyLink: 'https://square.link/u/zsgL3N5e',
    description: 'We all return to dust eventually.',
  };
