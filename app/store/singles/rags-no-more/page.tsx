...
export const metadata: Metadata = {
  title: 'Rags No More | Chronix',
  description: 'Buy Rags No More by Chronix. Digital download $0.99',
};

export default function RagsNoMorePage() {
  const single = {
    title: 'Rags No More',
    artist: 'Chronix',
    album: 'Descend',
    ...
    price: 0.99,
    catalog: 'RRN-CHX-D03',
    buyLink: 'https://square.link/u/tW4GpZEt',
    description: 'Rising from nothing to become something.',
  };
