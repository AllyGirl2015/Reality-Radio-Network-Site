...
export const metadata: Metadata = {
  title: 'Country Looks | Johnathan Gold & Guilded Hearts',
  description: 'Buy Country Looks by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function CountryLooksPage() {
  const single = {
    title: 'Country Looks',
    ...
    price: 0.99,
    catalog: 'RRN-JG-GH03',
    buyLink: 'https://square.link/u/FT28aIJZ',
    description: 'Those eyes that can only come from the heartland.',
  };
