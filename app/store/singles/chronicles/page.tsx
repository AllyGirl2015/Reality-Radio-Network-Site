...
export const metadata: Metadata = {
  title: 'Chronicles | Mathew Cage',
  description: 'Buy Chronicles by Mathew Cage. Digital download $0.99',
};
...
export default function ChroniclesPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-MC-HH05',
    buyLink: 'https://square.link/u/kEfKJCIE',
    description: 'The story of a life lived on the edge.',
  };
