...
export const metadata: Metadata = {
  title: 'Drown it Out | Mathew Cage',
  description: 'Buy Drown it Out by Mathew Cage. Digital download $0.99',
};

export default function DrownItOutPage() {
  const single = {
    title: 'Drown it Out',
    artist: 'Mathew Cage',
    album: 'High Hit',
    ...
    price: 0.99,
    catalog: 'RRN-MC-HH04',
    buyLink: 'https://square.link/u/KCOOq0Jr',
    description: 'Sometimes you need to silence the noise.',
  };
