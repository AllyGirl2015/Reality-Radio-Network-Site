...
export const metadata: Metadata = {
  title: 'Starting Line | Chronix',
  description: 'Buy Starting Line by Chronix. Digital download $0.99',
};

export default function StartingLinePage() {
  const single = {
    title: 'Starting Line',
    artist: 'Chronix',
    album: 'Descend',
    ...
    price: 0.99,
    catalog: 'RRN-CHX-D01',
    buyLink: 'https://square.link/u/EQCSb9Zm',
    description: 'The beginning of a dark electronic journey into the depths.',
  };
