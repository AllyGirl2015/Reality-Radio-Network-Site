...
export const metadata: Metadata = {
  title: 'Love Killer | Kaira Heartfelt',
  description: 'Buy Love Killer by Kaira Heartfelt. Digital download $0.99',
};

export default function LoveKillerPage() {
  const single = {
    title: 'Love Killer',
    ...
    price: 0.99,
    catalog: 'RRN-KH-SL02',
    buyLink: 'https://square.link/u/YkZwnMzA',
    description: 'When love becomes dangerous.',
  };
