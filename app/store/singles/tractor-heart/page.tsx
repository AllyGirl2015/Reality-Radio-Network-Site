...
export const metadata: Metadata = {
  title: 'Tractor Heart | Johnathan Gold & Guilded Hearts',
  description: 'Buy Tractor Heart by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function TractorHeartPage() {
  const single = {
    title: 'Tractor Heart',
    ...
    price: 0.99,
    catalog: 'RRN-JG-GH04',
    buyLink: 'https://square.link/u/yc0nV212',
    description: 'Love as steady and reliable as a farm at dawn.',
  };
