...
export const metadata: Metadata = {
  title: 'Fractured Signal | Mathew Cage',
  description: 'Buy Fractured Signal by Mathew Cage. Digital download $0.99',
};

export default function FracturedSignalPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-MC-SP02',
    buyLink: 'https://square.link/u/2OwcTGU3',
    description: 'When communication breaks down and static takes over.',
  };
