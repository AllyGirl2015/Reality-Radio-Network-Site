...
export const metadata: Metadata = {
  title: 'She Wore Red, I Wore Blue | Johnathan Gold & Guilded Hearts',
  description: 'Buy She Wore Red, I Wore Blue by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function SheWoreRedIWoreBluePage() {
  const single = {
    title: 'She Wore Red, I Wore Blue',
    ...
    price: 0.99,
    catalog: 'RRN-JG-AC03',
    buyLink: 'https://square.link/u/U5l7NWyv',
    description: 'A colorful tale of contrasts in love and life.',
  };
