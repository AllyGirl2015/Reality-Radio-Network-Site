...
export const metadata: Metadata = {
  title: 'Heartfelt Rebellion | Johnathan Gold',
  description: 'Buy Heartfelt Rebellion by Johnathan Gold. Defiant anthem wrapped in soul-soaked strings. Digital download $0.99',
};

export default function HeartfeltRebellionSinglePage() {
  const single = {
    title: 'Heartfelt Rebellion',
    artist: 'Johnathan Gold',
    album: 'Heartfelt Rebellion',
    genre: 'Country Rock / Soul Country',
    year: 2025,
    duration: '4:05',
    price: 0.99,
    catalog: 'RRN-JGGH-HR01',
    youtubeId: '', // Add YouTube video ID here when available
    description: 'A defiant anthem wrapped in soul-soaked strings and twangy rebellion, "Heartfelt Rebellion" is Johnathan Gold at his most authentic. This track speaks to anyone who\'s ever stood against the grain, choosing the honest road over the easy one. It\'s equal parts fire and grace.',
    quote: '"Rebellion isn\'t always loud… sometimes it\'s just staying true."',
  };
    ...
    <main className="min-h-screen pt-24">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-[300px_1fr] gap-12 items-start">
            <div className="relative">
              <div className="relative aspect-square rounded-lg overflow-hidden border-2 border-purple-500/30 shadow-2xl shadow-purple-500/20 bg-gradient-to-br from-orange-500/20 to-purple-500/20 flex items-center justify-center">
            ...
            <div>
              ...
              <div className="mb-3">
                <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-orange-400 to-purple-500 bg-clip-text text-transparent">
                  {single.title}
                </h1>
              ...
              <div className="bg-gradient-to-r from-purple-600/20 to-orange-600/20 border border-purple-400/30 rounded-lg p-6 mb-6">
                ...
                <a 
                  href="https://square.link/u/XabI1gG5?src=embed"
                  target="_blank"
      ...
      {single.youtubeId && (
        <Section background="solid">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-orange-400 to-purple-400 bg-clip-text text-transparent">
              Listen Now
            </h2>
      ...
      <Section background={single.youtubeId ? "gradient" : "solid"}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-orange-500 bg-clip-text text-transparent">
          ...
          <p className="text-lg text-gray-300 mb-6">
            ...
            13 soulful tracks for just $8.99
          </p>
      ...
      <Section background={single.youtubeId ? "solid" : "gradient"}>
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-orange-400 to-purple-400 bg-clip-text text-transparent">
            Track Information
          </h2>
      ...
      <Section>
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-orange-500 bg-clip-text text-transparent">
            You Might Also Like
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {[
            ...
            { title: 'Chaos Country', artist: 'Johnathan Gold', slug: 'chaos-country' },
            { title: 'Evil Love', artist: 'Kaira Heartfelt', slug: 'evil-love' },
          ].map((track) => (
            <Link
              key={track.slug}
