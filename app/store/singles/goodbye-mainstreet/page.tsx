...
export const metadata: Metadata = {
  title: 'Goodbye Mainstreet | Johnathan Gold & Guilded Hearts',
  description: 'Buy Goodbye Mainstreet by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function GoodbyeMainstreetPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-JG-AC02',
    buyLink: 'https://square.link/u/LOuRjMBD',
    description: 'A heartfelt farewell to simpler times and small-town roots.',
  };
