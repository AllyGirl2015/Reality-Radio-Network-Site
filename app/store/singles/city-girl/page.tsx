...
export const metadata: Metadata = {
  title: 'City Girl | Johnathan Gold & Guilded Hearts',
  description: 'Buy City Girl by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function CityGirlPage() {
  const single = {
    title: 'City Girl',
    ...
    price: 0.99,
    catalog: 'RRN-JG-GH02',
    buyLink: 'https://square.link/u/rseytD6W',
    description: 'When country hearts meet city lights.',
  };
