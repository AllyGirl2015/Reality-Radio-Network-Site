...
export const metadata: Metadata = {
  title: 'Echoes of the Cage | Mathew Cage',
  description: 'Buy Echoes of the Cage by Mathew Cage. Digital download $0.99',
};

export default function EchoesOfTheCagePage() {
  const single = {
    title: 'Echoes of the Cage',
    artist: 'Mathew Cage',
    ...
    price: 0.99,
    catalog: 'RRN-MC-SP04',
    buyLink: 'https://square.link/u/zwQRJCwe',
    description: 'The haunting reverberations of confinement and freedom.',
  };
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr] gap-6 md:gap-8 lg:gap-12 items-start">
            <div className="relative">
              <div className="relative aspect-square rounded-lg overflow-hidden border-2 border-red-500/30 shadow-2xl shadow-red-500/20 bg-gradient-to-br from-red-500/20 to-purple-500/20 flex items-center justify-center">
                <div className="text-center p-8">
                  <Music className="w-20 h-20 text-red-400 mx-auto mb-4" aria-hidden="true" />
                  <p className="text-sm text-gray-400 font-mono">SINGLE</p>
                </div>
              </div>
              
              <div className="mt-4 bg-black/60 backdrop-blur-md border border-red-500/30 rounded-lg p-4 text-sm space-y-2">
            ...
            <div>
              <div className="mb-4">
                <span className="inline-block px-3 py-1 bg-red-500/20 border border-red-400/30 rounded-full text-xs font-semibold text-red-400">SINGLE</span>
              </div>

              <div className="mb-3">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent">{single.title}</h1>
                <p className="text-lg sm:text-xl text-gray-300">{single.artist}</p>
              </div>

              <Link href={`/store/albums/${single.album.toLowerCase().replace(/ /g, '-')}`} className="inline-flex items-center gap-2 text-sm text-red-400 hover:text-red-300 transition-colors mb-6">
              ...
              <div className="bg-gradient-to-r from-red-600/20 to-orange-600/20 border border-red-400/30 rounded-lg p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <p className="text-4xl font-bold bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">${single.price.toFixed(2)}</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="https://live365.com/station/201-5-Reality-Central-Radio-a47993" target="_blank" rel="noopener noreferrer" className="flex-1 px-4 sm:px-6 py-3 border border-red-400/30 rounded-lg text-center text-sm sm:text-base text-red-400 hover:bg-red-500/10 hover:border-red-400 transition-all duration-300 flex items-center justify-center gap-2">
