...
export const metadata: Metadata = {
  title: 'One Drink | Mathew Cage',
  description: 'Buy One Drink by Mathew Cage. Digital download $0.99',
};

export default function OneDrinkPage() {
  const single = {
    title: 'One Drink',
    artist: 'Mathew Cage',
    album: 'High Hit',
    ...
    price: 0.99,
    catalog: 'RRN-MC-HH02',
    buyLink: 'https://square.link/u/POxETfEH',
    description: 'Sometimes one is all it takes to change everything.',
  };
