...
export const metadata: Metadata = {
  title: 'Lustful Love | Kaira Heartfelt',
  description: 'Buy Lustful Love by Kaira Heartfelt. Digital download $0.99',
};

export default function LustfulLovePage() {
  const single = {
    title: 'Lustful Love',
    ...
    price: 0.99,
    catalog: 'RRN-KH-SL01',
    buyLink: 'https://square.link/u/7Z7NtdOx',
    description: 'An intoxicating blend of desire and country soul.',
  };
