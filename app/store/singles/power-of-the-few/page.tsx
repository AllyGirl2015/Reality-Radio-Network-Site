...
export const metadata: Metadata = {
  title: 'Power of the Few | Chronix',
  description: 'Buy Power of the Few by Chronix. Digital download $0.99',
};

export default function PowerOfTheFewPage() {
  const single = {
    title: 'Power of the Few',
    artist: 'Chronix',
    album: 'Descend',
    ...
    price: 0.99,
    catalog: 'RRN-CHX-D02',
    buyLink: 'https://square.link/u/gILHmo6H',
    description: 'The strength found in unity and select bonds.',
  };
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr] gap-6 md:gap-8 lg:gap-12 items-start">
            <div className="relative">
              <div className="relative aspect-square rounded-lg overflow-hidden border-2 border-indigo-500/30 shadow-2xl shadow-indigo-500/20 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center">
                <div className="text-center p-8">
                  <Music className="w-20 h-20 text-indigo-400 mx-auto mb-4" aria-hidden="true" />
                  <p className="text-sm text-gray-400 font-mono">SINGLE</p>
                </div>
              </div>
              
              <div className="mt-4 bg-black/60 backdrop-blur-md border border-indigo-500/30 rounded-lg p-4 text-sm space-y-2">
            ...
            <div>
              <div className="mb-4">
                <span className="inline-block px-3 py-1 bg-indigo-500/20 border border-indigo-400/30 rounded-full text-xs font-semibold text-indigo-400">SINGLE</span>
              </div>

              <div className="mb-3">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-indigo-400 to-purple-500 bg-clip-text text-transparent">{single.title}</h1>
                <p className="text-lg sm:text-xl text-gray-300">{single.artist}</p>
              </div>

              <Link href="/store/albums/decend" className="inline-flex items-center gap-2 text-sm text-indigo-400 hover:text-indigo-300 transition-colors mb-6">
              ...
              <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-400/30 rounded-lg p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <p className="text-4xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">${single.price.toFixed(2)}</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="https://live365.com/station/201-5-Reality-Central-Radio-a47993" target="_blank" rel="noopener noreferrer" className="flex-1 px-4 sm:px-6 py-3 border border-indigo-400/30 rounded-lg text-center text-sm sm:text-base text-indigo-400 hover:bg-indigo-500/10 hover:border-indigo-400 transition-all duration-300 flex items-center justify-center gap-2">
