...
export const metadata: Metadata = {
  title: 'Hate No More | Chronix',
  description: 'Buy Hate No More by Chronix. Digital download $0.99',
};

export default function HateNoMorePage() {
  const single = {
    title: 'Hate No More',
    artist: 'Chronix',
    album: 'Descend',
    ...
    price: 0.99,
    catalog: 'RRN-CHX-D04',
    buyLink: 'https://square.link/u/GoUQUJXA',
