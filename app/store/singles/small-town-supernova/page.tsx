...
export const metadata: Metadata = {
  title: 'Small Town Supernova | Kaira Heartfelt',
  description: 'Buy Small Town Supernova by Kaira Heartfelt. Digital download $0.99',
};

export default function SmallTownSupernovaPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-KH-BS01',
    buyLink: 'https://square.link/u/5RtJRMKv',
    description: 'Small-town dreams with cosmic ambitions.',
  };
