...
export const metadata: Metadata = {
  title: 'Scraps | Mathew Cage',
  description: 'Buy Scraps by Mathew Cage. Digital download $0.99',
};
...
export default function ScrapsPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-MC-HH01',
    buyLink: 'https://square.link/u/Nk4Sjd9j',
    description: 'Raw and unfiltered emotion from the streets.',
  };
