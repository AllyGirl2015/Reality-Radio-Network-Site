...
export const metadata: Metadata = {
  title: 'Back When We Fell | Johnathan Gold & Guilded Hearts',
  description: 'Buy Back When We Fell by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function BackWhenWeFellPage() {
  const single = {
    title: 'Back When We Fell',
    ...
    price: 0.99,
    catalog: 'RRN-JG-GH01',
    buyLink: 'https://square.link/u/wX1OkEC7',
    description: 'A nostalgic journey through memories of first love.',
  };
