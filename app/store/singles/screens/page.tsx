...
export const metadata: Metadata = {
  title: 'Screens | Johnathan Gold & Guilded Hearts',
  description: 'Buy Screens by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};
...
export default function ScreensPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-JG-HR03',
    buyLink: 'https://square.link/u/c8Gi0DAC',
    description: 'A reflection on our digital disconnect.',
  };
