...
export const metadata: Metadata = {
  title: 'Fallen Flag | Mathew Cage',
  description: 'Buy Fallen Flag by Mathew Cage. Cinematic alt-rock ballad that grieves what we lost. Digital download $1.99',
};

export default function FallenFlagSinglePage() {
  const single = {
    title: 'Fallen Flag',
    artist: 'Mathew Cage',
    ...
    <main className="min-h-screen pt-24">
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr] gap-6 md:gap-8 lg:gap-12 items-start">
            ...
            <div>
              ...
              <div className="bg-black/60 border-l-4 border-red-400 rounded-r-lg p-4 mb-8">
                <p className="text-gray-300 italic">{single.quote}</p>
              </div>

              <div className="bg-gradient-to-r from-red-600/20 to-purple-600/20 border border-red-400/30 rounded-lg p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-bold text-white mb-1">Digital Download</h3>
                    <p className="text-sm text-gray-400">Instant delivery • High-quality MP3 • Extended Version</p>
                  </div>
                  <p className="text-4xl font-bold bg-gradient-to-r from-red-400 to-purple-400 bg-clip-text text-transparent">
                    ${single.price.toFixed(2)}
                  </p>
                </div>
                <a 
                  href="https://square.link/u/VEMs3Tdc?src=embed"
                  target="_blank"
      ...
      {single.youtubeId && (
        <Section background="solid">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-red-400 to-purple-400 bg-clip-text text-transparent">
              Listen Now
            </h2>
      ...
      <Section background={single.youtubeId ? "gradient" : "solid"}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-6">
            ...
            10 powerful tracks for just $8.99
          </p>
      ...
      <Section background={single.youtubeId ? "solid" : "gradient"}>
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-red-400 to-purple-400 bg-clip-text text-transparent">
            Track Information
          </h2>
      ...
      <Section>
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-red-400 to-purple-500 bg-clip-text text-transparent">
            You Might Also Like
          </h2>
        </div>
