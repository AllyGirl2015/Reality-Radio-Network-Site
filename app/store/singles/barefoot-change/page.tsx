...
export const metadata: Metadata = {
  title: 'Barefoot Change | Kaira Heartfelt',
  description: 'Buy Barefoot Change by Kaira Heartfelt. Digital download $0.99',
};

export default function BarefootChangePage() {
  const single = {
    title: 'Barefoot Change',
    ...
    price: 0.99,
    catalog: 'RRN-KH-BS03',
    buyLink: 'https://square.link/u/PQH2CVWU',
    description: 'Embracing transformation with bare feet on the ground.',
  };
