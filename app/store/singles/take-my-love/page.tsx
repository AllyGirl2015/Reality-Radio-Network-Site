...
export const metadata: Metadata = {
  title: 'Take My Love | Kaira Heartfelt',
  description: 'Buy Take My Love by Kaira Heartfelt. Digital download $0.99',
};

export default function TakeMyLovePage() {
  const single = {
    title: 'Take My Love',
    ...
    price: 0.99,
    catalog: 'RRN-KH-SL04',
    buyLink: 'https://square.link/u/8kANPQUF',
    description: 'An open-hearted offer of unconditional love.',
  };
