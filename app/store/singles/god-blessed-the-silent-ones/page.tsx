...
export const metadata: Metadata = {
  title: 'God Blessed the Silent Ones | Johnathan Gold & Guilded Hearts',
  description: 'Buy God Blessed the Silent Ones by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function GodBlessedTheSilentOnesPage() {
  const single = {
    title: 'God Blessed the Silent Ones',
    ...
    price: 0.99,
    catalog: 'RRN-JG-AC04',
    buyLink: 'https://square.link/u/CRptBh7b',
    description: 'A tribute to the unsung heroes who quietly persevere.',
  };
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr] gap-6 md:gap-8 lg:gap-12 items-start">
            ...
            <div>
              ...
              <Link href="/store/albums/americas-changed" className="inline-flex items-center gap-2 text-sm text-cyan-400 hover:text-cyan-300 transition-colors mb-6">
