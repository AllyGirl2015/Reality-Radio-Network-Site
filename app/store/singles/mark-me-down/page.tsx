...
export const metadata: Metadata = {
  title: 'Mark Me Down | Chronix',
  description: 'Buy Mark Me Down by Chronix. Digital download $0.99',
};

export default function MarkMeDownPage() {
  const single = {
    title: 'Mark Me Down',
    artist: 'Chronix',
    album: 'Descend',
    ...
    price: 0.99,
    catalog: 'RRN-CHX-D05',
    buyLink: 'https://square.link/u/1vzafXZ0',
    description: 'Recording your presence in the annals of time.',
  };
