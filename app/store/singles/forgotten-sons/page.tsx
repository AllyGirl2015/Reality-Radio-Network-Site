...
export const metadata: Metadata = {
  title: 'Forgotten Sons | Johnathan Gold & Guilded Hearts',
  description: 'Buy Forgotten Sons by Johnathan Gold & Guilded Hearts. Digital download $0.99',
};

export default function ForgottenSonsPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-JG-HR04',
    buyLink: 'https://square.link/u/4X4F5rfO',
    description: 'An anthem for those left behind by progress.',
  };
