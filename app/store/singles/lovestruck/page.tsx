...
export const metadata: Metadata = {
  title: 'Lovestruck | Kaira Heartfelt',
  description: 'Buy Lovestruck by Kaira Heartfelt. Digital download $0.99',
};
...
export default function LovestruckPage() {
  const single = {
    ...
    price: 0.99,
    catalog: 'RRN-KH-BS04',
    buyLink: 'https://square.link/u/4fIryxQD',
    description: 'That overwhelming feeling when love hits you.',
  };
