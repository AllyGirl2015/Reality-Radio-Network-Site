...
export const metadata: Metadata = {
  title: 'Country Girl | Kaira Heartfelt',
  description: 'Buy Country Girl by Kaira Heartfelt. Digital download $0.99',
};

export default function CountryGirlPage() {
  const single = {
    title: 'Country Girl',
    ...
    price: 0.99,
    catalog: 'RRN-KH-BS02',
    buyLink: 'https://square.link/u/l6cgNAC8',
    description: 'An anthem for every girl with country roots.',
  };
