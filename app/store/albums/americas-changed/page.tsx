        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <Link href={`/artists/${album.artist.toLowerCase().replace(/ & .+/, '').replace(' ', '-')}`} className="px-6 py-3 border border-cyan-400/30 rounded-lg text-center text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-400 transition-all duration-300">
                View Artist
              </Link>
            </div>
          </div>
