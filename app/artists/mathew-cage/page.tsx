            ...
            {albums.map((album) => (
              ...
              >
                <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
                  <div className="aspect-square bg-gradient-to-br from-red-500/20 to-purple-500/20 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform">
